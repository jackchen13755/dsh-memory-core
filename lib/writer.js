 ...
 */
export function writeMemory({ store, recall, input, cwd = null, origin = 'tool', force = false, queueOnly = false }) {
...
export function approveSuggestion({ store, id, overrides = {}, decidedBy = 'user' }) {
  ...
  const scope = overrides.scope ?? merged.scope ?? 'global'
